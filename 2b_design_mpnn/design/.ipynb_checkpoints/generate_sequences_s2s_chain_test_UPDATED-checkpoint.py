...
# sys.path.append('/home/robpec/mpnn_dataset/training_the_model/justas_git/proteinmpnn_old/ligand_proteinmpnn')
sys.path.append('/projects/protein-DNA-binders/scripts/proteinmpnn/ligandMPNN')
